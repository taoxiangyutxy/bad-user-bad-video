 ...
 * 外挂举报信息管理控制器
 *
 * 提供外挂举报信息的增删改查、审核、点赞等功能
 * 一个外挂账号会有多个举报信息，直到被永封该账号不会再接受新的举报信息。
 */
...
public class InfoController {
     ...
     * 对外挂举报信息进行点赞
     *
     * @param givelikeEntity 点赞实体
     * @return 操作结果
     */
    @Operation(summary = "点赞", description = "对外挂举报信息进行点赞")
    @PostMapping("/giveLikeInfo")
